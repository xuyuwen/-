<?php
/* Smarty version 3.1.32, created on 2018-11-21 21:53:15
  from 'F:\code\blog\App\Admin\View\Article\add.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5bf5634b141cd9_10687656',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '4aaea61b91f9c5916485fae9c34ca0dba1711fd3' => 
    array (
      0 => 'F:\\code\\blog\\App\\Admin\\View\\Article\\add.html',
      1 => 1542808378,
      2 => 'file',
    ),
  ),
...
function content_5bf5634b141cd9_10687656 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="zh-cn">
<head>
...
>
<?php echo '<script'; ?>
 type="text/javascript" src="App/Public/utf8-php/ueditor.config.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 type="text/javascript" src="App/Public/utf8-php/ueditor.all.js"><?php echo '</script'; ?>
>
  ...
  <div class="tab">
    ...
    <div class="tab-body"> <br />
      <div class="tab-panel active" id="tab-set">
        <form method="post" class="form-x" enctype="multipart/form-data" action="index.php?g=Admin&c=Article&a=insert">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
          ...
          <div class="form-group">
              <div class="label">
                <label for="tags">请输入关键词</label>
              </div>
              <div class="field">
                <input type="text" class="input" id="author" name="tags"  placeholder="关键词以逗号分隔"  />
              </div>
            </div>
          <div class="form-group">
            <div class="label">
          ...
          <div class="form-group">
            ...
            <div class="field">
              <textarea id="ue" rows="5" name="content" cols="50" placeholder="内容" data-validate="required:请填写文章描述"></textarea>
              <?php echo '<script'; ?>
